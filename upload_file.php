...
<?php
$koneksi =mysqli_connect("localhost","root","","asetnegla62");
...
echo "<script>alert('Data Berhasil Di Upload');window.location='index.php'</script>";
  ...
  <!-- ***** Main Banner Area Start ***** -->
    <div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                <h6><i>Upload Dokumen</i></h6>
                <div class="main-button scroll-to-section">
				
                 <form action="" method="POST" enctype="multipart/form-data">
				 

<h6><i>File Upload</i></h6><input Type="file" name="NamaFile" >
</div>
